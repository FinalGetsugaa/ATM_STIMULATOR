...
public class Signup3 extends JFrame implements ActionListener {
    ...
    Signup3(){
        ...
        int x = fm.stringWidth("NEW ACCOUNT OPENING APPLICATION FORM - PAGE 3");
        ...
        setTitle(pad+"NEW ACCOUNT OPENING APPLICATION FORM - PAGE 3");
    ...
    // Overriding the actionPerformed Function of ActionListener Interface
     ...
     public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            if(ae.getSource()==b1){                     // If submit button is clicked
