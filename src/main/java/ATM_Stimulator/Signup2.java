...
public class Signup2 extends JFrame implements ActionListener {
    ...
    Signup2(){
        ...
        int x = fm.stringWidth("NEW ACCOUNT OPENING APPLICATION FORM - PAGE 2");
        ...
        setTitle(pad+"NEW ACCOUNT OPENING APPLICATION FORM - PAGE 2");
...
public void actionPerformed(ActionEvent ae){
        ...
        try{
            ...
            {                                                                                // Perform Query Action After Clicking on Next Button
                conn c1 = new conn();
